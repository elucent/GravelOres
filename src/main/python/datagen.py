...
ORES = {
    ...
    # compat
    "aluminum": {
        "mods": ["allomancy", "cosmere", "immersiveengineering", "modern_industrialization", "xycraft_world"],
        "tier": "stone",
    ...
    "lead": {
        "mods": ["allomancy", "cosmere", "eidolon", "embers", "immersiveengineering", "mekanism", "modern_industrialization", "oreganized", "railcraft", "thermal"],
        "tier": "iron",  # mekansim says stone, consensus iron
        "tag_drop": "raw_materials",
        "overworld_chance": 750  # Embers 8, Thermal 6, Mek 8
    },
    "nickel": {
        "mods": ["cosmere", "immersiveengineering", "modern_industrialization", "railcraft", "thermal"],
        "tier": "iron",
        "tag_drop": "raw_materials",
    ...
    "uranium": {
        "mods": ["biggerreactors", "bigreactors", "immersiveengineering", "mekanism", "modern_industrialization"],
